...
class Instance(object):
    """
    This represents the input examples set used to solve.
    It doesn't include the solution.
    The methods help get useful information from the dataset.
    The examples is stored in .examples at it consists on a dictionary of dictionaries.
    The structure is:

    - parameters: 1-dimension examples
    - tasks: examples related to tasks
    - resources: examples related to resources
    - maintenances: examples related to maintenances (smaller for now)
    - maint_types: examples related to capacity or maintenance type
    - aux: cached examples (months, for example)
    """
    ...
    def get_capacity_calendar(self, periods=None):
        ...
        """
        # This should be replaced by reference to the correct maintenance examples
